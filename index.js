...
bot.onText(/\/pair/, async (msg) => {
    ...
    const waitingMsg = await bot.sendMessage(chatId, '⏳ *Please wait...* Spawning secure temporary instance...', {
    ...
    setTimeout(async () => {
        try {
            // Fix: Dynamic import to handle Baileys ES Module structure
...
app.listen(PORT, () => {
    console.log(`🚀 Dedicated Dynamic-Import Engine running on port ${PORT}`);
});
